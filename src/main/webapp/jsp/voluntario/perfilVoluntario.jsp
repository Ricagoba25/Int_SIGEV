...
<head>
  ...
  <title>SIGEV | Perfil Voluntario </title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a href="/jsp/voluntario/perfilVoluntario.jsp">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link">
                  ...
                  <p style="margin-left: 10px">Disponibles</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="fa-regular fa-calendar-xmark"></i>
                  <p style="margin-left: 10px">Postulados</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link">
          ...
          <form action="../../index.jsp" method="post">
            ...
            <div class="row mt-2">
              ...
              <div class="col-xl-4">
                ...
                <input type="text" value="${curp}" name="curp" class="form-control"
                       id="curp">
              </div>
            </div>
