                    ...
                    <form action="../../index.jsp" method="post">
                        <div class="row mt-2">
                            <div class="col-xl-4">
                                ...
                                <input type="text" value="${sesion.getNombrePersona()}" name="nombre" class="form-control" id="nombre">
                            </div>
                            <div class="col-xl-4">
                                <label for="primerApellido" class="form-label">Apellido Paterno:</label>
                                <input type="text" class="form-control" value="${sesion.getPrimerApellido()}" name="primerApellido"
                                       id="primerApellido">
                            </div>
                            <div class="col-xl-4">
